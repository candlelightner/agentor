...
const groupDescriptions: Record<string, string> = {
  ...
  storage: "Offline workspace inventory, browsing, cloning, and bounded downloads.",
  "running-files": "Manage files in a running worker workspace; writes honor worker locks.",
  "worker-lifecycle": "Create, update, restart, rebuild, archive, clone, and delete workers.",
  console: "Open bounded interactive terminal sessions inside selected workers.",
  configuration: "Set worker-local variables and write-only secrets or secret files.",
  groups: "Create and manage practical worker groups.",
  locks: "Set, inspect, or remove per-worker protection locks.",
  images: "Manage approved-base image definitions, versions, builds, and recovery.",
  networking: "Manage worker networks and port or domain mappings; never the management network.",
  apps: "Inspect, start, and stop supported applications inside selected workers.",
  "storage-maintenance": "Inspect installation disk use and run conservative cleanup actions.",
  catalogs: "Manage user environments, capabilities, instructions, and init scripts.",
  exports: "Create, inspect, cancel, and locate streaming export downloads.",
  backups: "Configure, create, inspect, retry, cancel, restore, and delete backups.",
  "image-builds": "Legacy image-build compatibility tools; prefer the Images group.",
