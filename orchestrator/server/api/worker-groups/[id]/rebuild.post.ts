defineRouteMeta({
  openAPI: {
    tags: ["Worker groups"],
    summary: "Rebuild all workers in a group subtree",
    description:
      "Rebuilds every ordinary worker directly in this group or a descendant group while preserving durable data and group membership. Administrative workspaces are not affected. All protection locks are verified before any worker is changed.",
    operationId: "rebuildWorkerGroupSubtree",
    responses: {
      200: { description: "Recursive rebuild result" },
