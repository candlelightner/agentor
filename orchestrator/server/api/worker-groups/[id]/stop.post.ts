defineRouteMeta({
  openAPI: {
    tags: ["Worker groups"],
    summary: "Stop all workers in a group subtree",
    description:
      "Stops every ordinary worker directly in this group or a descendant group. Administrative workspaces are not affected. All protection locks are verified before any worker is changed.",
    operationId: "stopWorkerGroupSubtree",
    responses: {
      200: { description: "Recursive stop result" },
