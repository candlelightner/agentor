        ...
        schemas: {
          ContainerInfo: {
            ...
            properties: {
              ...
              status: { type: 'string', enum: ['creating', 'starting', 'running', 'stopped', 'recovering', 'unknown', 'removing', 'error'] },
              desiredRuntimeStatus: { type: 'string', enum: ['running', 'stopped'], description: 'Durable lifecycle intent used after daemon/orchestrator restarts.' },
              runtimeDiagnostic: { type: 'object', description: 'Safe structured reason when the live Docker task could not be verified.' },
