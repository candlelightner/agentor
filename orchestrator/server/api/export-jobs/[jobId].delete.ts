defineRouteMeta({
  openAPI: {
    ...
    responses: { 200: { description: 'Export job cancelled or already terminal', content: { 'application/json': { schema: { $ref: '#/components/schemas/ExportJob' } } } }, 401: { description: 'Unauthorized' }, 403: { description: 'Forbidden' }, 404: { description: 'Job not found' } },
  },
});
