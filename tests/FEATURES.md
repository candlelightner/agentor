...
- The group admin's MCP identity is limited to the group's live same-owner members. It delegates member inspection/metrics, lifecycle, configuration/locks, console/logs, running and offline files, exports, backups, apps, and creation of mappings that explicitly name a member. Discovery and list results omit non-members; direct calls naming a known non-member or cross-user worker fail. Membership additions grant and removals revoke access immediately.
